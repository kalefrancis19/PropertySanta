...
export function Notification({ 
  ...
  console.log('Notification component rendered:', { type, title, message, show, isVisible, isAnimating });
...
export function NotificationContainer({ notifications, removeNotification }: {
  ...
  console.log('NotificationContainer rendered with notifications:', notifications);
