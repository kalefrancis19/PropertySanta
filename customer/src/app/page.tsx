...
export default function DashboardPage() {
  ...
  useEffect(() => {
    console.log('Dashboard useEffect - authLoading:', authLoading, 'currentUser:', currentUser);
  ...
  console.log('Dashboard render - loading:', loading, 'authLoading:', authLoading);
        ...
        <DashboardLayout>
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500 mt-2">Loading: {loading}, Auth Loading: {authLoading ? 'true' : 'false'}</p>
            </div>
          </div>
        </DashboardLayout>
      </ProtectedRoute>
